 ...
 */
public class UNREDDChartData
    extends UNREDDResource<UNREDDChartData.Attributes,
                           UNREDDChartData.ReverseAttributes> {

    private final static Logger LOGGER = LoggerFactory.getLogger(UNREDDChartData.class);

    public static final String CATEGORY_NAME = UNREDDCategories.CHARTDATA.getName();
...
//        public final static ReverseAttributes LAYER = new ReverseAttributes("Layer");
    ...
    public static class Attributes extends AttributeDef {
        ...
        public final static Attributes CHARTSCRIPT = new Attributes("ChartScript", DataType.STRING);
        //public final static Attributes LANGUAGE    = new Attributes("Language", DataType.STRING);
        //public final static Attributes FORMAT      = new Attributes("Format", DataType.STRING);
        public final static Attributes PUBLISHED   = new Attributes("Published", DataType.STRING);
        public final static Attributes FEATUREID   = new Attributes("FeatureId", DataType.STRING);
    ...
    public UNREDDChartData() {
    }

    public UNREDDChartData(Resource resource) {
        super(resource);
    }
