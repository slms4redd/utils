...
public class UNREDDChartScript
    ...
    public static class ReverseAttributes extends ReverseAttributeDef {
        ...
        public final static ReverseAttributes STATSDEF = new ReverseAttributes("StatsDef");
    ...
    public static class Attributes extends AttributeDef {
        ...
        public final static Attributes SCRIPTPATH = new Attributes("ScriptPath", DataType.STRING);
    ...
    public UNREDDChartScript(Resource resource) {
        super(resource);
    }
